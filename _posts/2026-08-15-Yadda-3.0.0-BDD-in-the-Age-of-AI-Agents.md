...
For anyone unfamiliar with it, [Yadda](https://github.com/acuminous/yadda) is a Behaviour Driven Development (BDD) library for JavaScript. Like Cucumber, it maps ordinary language specifications to executable code, but it was designed from the ground up to be much less prescriptive about how those specifications are written.
